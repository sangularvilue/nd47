...
A non-commercial fan project: a walkable 3D model of the University of Notre Dame campus on a football Saturday,
built as the prototype for a Hitman-style game. Not affiliated with or endorsed by the University of Notre Dame.

**Play:** open the GitHub Pages URL for this repo. Desktop: WASD + mouse, F drone, M map, 1–7 landmarks, O quality, G Google reference.
Phone: left thumb joystick, drag right side to look.
